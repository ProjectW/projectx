...
ActiveRecord::Schema.define(version: 20141012144703) do
  ...
  create_table "company_profile_watches", force: true do |t|
    t.integer  "company_id",                        null: false
    t.integer  "student_account_id",                null: false
  ...
  add_index "company_profile_watches", ["company_id", "student_account_id"], name: "index_on_company_student_account_id", using: :btree
  add_index "company_profile_watches", ["watching"], name: "index_on_watching", using: :btree
